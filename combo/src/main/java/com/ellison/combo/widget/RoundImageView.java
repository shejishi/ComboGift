package com.ellison.combo.widget;
...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mProgressColor =  a.getColor(R.styleable.RoundImageView_progress_color, Color.WHITE);
        mBorderProgress = a.getInteger(R.styleable.RoundImageView_progress_border, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (type == TYPE_ROUND) {
            ...
            //进度
            mBorderPaint.setColor((int) mProgressColor);
