package com.ellison.combo.utils;
 ...
 * @author ellison
 */
public class LiveGiftAnimationUtil {
     ...
     * 礼物飞入动画
     */
    public static ObjectAnimator createFlyFromLtoR(final View target, float star, float end, long duration, TimeInterpolator interpolator) {
        //1.个人信息先飞出来
...
//                1f);
     ...
     * @return 按顺序播放动画
     */
    public static AnimatorSet startAnimation(ObjectAnimator animator1, ObjectAnimator animator2, ObjectAnimator animator3, ObjectAnimator animator4) {
        AnimatorSet animSet = new AnimatorSet();
        animSet.play(animator1).before(animator2);
        animSet.play(animator3).after(animator2);
